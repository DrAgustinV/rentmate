...
export function ResultsStep({ summary, onStartNew }: ResultsStepProps) {
      ...
      <Card className="p-6 space-y-4">
        ...
        <div className="space-y-2 pt-4 border-t">
          <div className="flex justify-between text-sm">
            ...
            <Badge variant="outline">{summary.propertiesCreated}</Badge>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">Tenant invitations sent:</span>
            <Badge variant="outline">{summary.invitationsSent}</Badge>
          </div>
        </div>
