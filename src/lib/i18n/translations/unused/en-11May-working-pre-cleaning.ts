...
export const en = {
  ...
  properties: {
    ...
    invited: "Invited",
    manageTenantDescription: "Manage tenants, invitations, and lease documents",
    manageTenants: "Manage Tenants",
    noDocumentsDesc: "Upload property documents such as contracts and warranties",
    ...
    noTenancyHistory: "No previous tenancies",
    ...
    propertyTemplatesDescription: "Reusable document templates for this property, e.g., contracts",
...
statusIndicators: {
    ...
    archivePropertyWarning: "This property has no active tenants. You can archive it if it is no longer in use.",
    archivePropertyWithTenantDescription: "Warning: This property has an active tenant. Are you sure you want to archive it? This will affect their lease. You can restore it later from archived properties.",
    archivePropertyWithTenantWarning: "Warning: This property has an active tenant",
    archiveReasonMerged: "Merged with Another Property",
    archiveReasonNoLongerManaging: "No Longer Managing",
    archiveReasonOther: "Other",
    archiveReasonSold: "Sold",
    archivedDetails: "Archive Details",
  ...
  maintenance: {
    ...
    calendarView: {
      ...
      nextRun: "Next run:",
      noTasks: "No maintenance tasks scheduled yet",
    },
    scheduledTasks: {
  ...
  configuration: {
    ...
    documentTemplates: {
      ...
      helper: "Create document templates that can be copied to properties. These templates are available across all your properties.",
      seachPlaceholderr: " ",
      templateCreated: "Template created sucessfully",
  ...
  terms: {
    ...
    useLicenseText: "Permission is granted to temporarily access and use FlatMate for personal or commercial property management purposes. This is the grant of a license, not a transfer of title, and under this license you may not:",
    ...
    useLicenseList4: "Remove any copyright or proprietary notation",
  ...
  tenants: {
    ...
    statusHistoricDesc: "Tenancy ended",
