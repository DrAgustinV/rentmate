...
export const en = {
  ...
  rentAgreement: {
    ...
    cannotEditDuringSigning: "Cannot edit during contract signing",
    editTitle: "Edit Rent Agreement",
    editDesc: "Update the rent agreement details. Tenant will be notified of changes.",
  },
  rentPayments: {
