#!/usr/bin/env python3
"""
Extract all translation keys from en.ts and save as CSV
"""
...
def save_to_csv(translations: Dict[str, str], output_file: str = 'translation_keys_en.csv'):
...
def main():
    try:
        ...
        print("Extracting translation keys from en.ts...")
        ...
        # Save to CSV
        save_to_csv(translations, 'translation_keys_en.csv')
        ...
        print("❌ Error: en.ts file not found in current directory")
