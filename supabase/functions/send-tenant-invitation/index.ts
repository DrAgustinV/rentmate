...
const getEmailContent = (data: InvitationEmailRequest) => {
        ...
        <html>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                <p>¡Hola!</p>
                <p><strong>${data.managerName}</strong> te ha invitado a unirte como inquilino de:</p>
                ...
                <p>Podrás:</p>
                <ul>
                  <li>Reportar y hacer seguimiento de tickets de mantenimiento</li>
                  <li>Ver documentos de la propiedad</li>
                  <li>Comunicarte con el administrador</li>
  ...
  // English version
  return {
    subject: `You're Invited to Join ${data.propertyTitle}`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p>Hi there!</p>
              <p><strong>${data.managerName}</strong> has invited you to become a tenant of:</p>
